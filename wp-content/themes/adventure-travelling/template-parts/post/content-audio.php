...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <div class="page-box row">
    ...
    <div class="box-content">
      ...
      <p><?php $adventure_travelling_excerpt = get_the_excerpt(); echo esc_html( adventure_travelling_string_limit_words( $adventure_travelling_excerpt, esc_attr(get_theme_mod('adventure_travelling_excerpt_count','35')))); ?></p>
