<?php
	...
	if($adventure_travelling_tp_color_option != false){
		$adventure_travelling_tp_theme_css .='#slider .inner_carousel h2,#static-blog h3,.search_inner form.search-form{';
	...
	if($adventure_travelling_tp_footer_bg_color_option != false){
		$adventure_travelling_tp_theme_css .='#footer{';
			$adventure_travelling_tp_theme_css .='background: '.esc_attr($adventure_travelling_tp_footer_bg_color_option).'; !important';
		$adventure_travelling_tp_theme_css .='}';
	}
