...
function adventure_travelling_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section('adventure_travelling_blog_option',array(
		...
		$wp_customize->add_control( new Adventure_Travelling_Toggle_Control( $wp_customize, 'adventure_travelling_remove_date', array(
			'label'       => esc_html__( 'Show / Hide Date Option', 'adventure-travelling' ),
    ...
    $wp_customize->selective_refresh->add_partial( 'adventure_travelling_remove_date', array(
		...
		$wp_customize->add_control( new Adventure_Travelling_Toggle_Control( $wp_customize, 'adventure_travelling_remove_author', array(
			'label'       => esc_html__( 'Show / Hide Author Option', 'adventure-travelling' ),
			'section'     => 'adventure_travelling_blog_option',
			'type'        => 'toggle',
			'settings'    => 'adventure_travelling_remove_author',
			) ) );
    $wp_customize->selective_refresh->add_partial( 'adventure_travelling_remove_author', array(
		...
		$wp_customize->add_control( new Adventure_Travelling_Toggle_Control( $wp_customize, 'adventure_travelling_remove_comments', array(
			'label'       => esc_html__( 'Show / Hide Comment Option', 'adventure-travelling' ),
			'section'     => 'adventure_travelling_blog_option',
			'type'        => 'toggle',
			'settings'    => 'adventure_travelling_remove_comments',
			) ) );
